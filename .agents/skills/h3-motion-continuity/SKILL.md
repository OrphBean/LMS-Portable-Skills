...
`instruct` â€” deterministic physical-language rules applied within the active
...
`START STATE â†’ PREPARATION â†’ WEIGHT OR FORCE TRANSFER â†’ PRIMARY MOTION â†’ CONTACT OR ARRIVAL â†’ SETTLED END STATE`
