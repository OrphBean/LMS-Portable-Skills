...
`instruct` — deterministic timeline construction from an explicit procedure.
...
cinematic phrasing, shot-level embellishment, and transition dynamics — within
